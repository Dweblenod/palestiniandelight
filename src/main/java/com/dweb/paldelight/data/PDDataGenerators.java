...
public class PDDataGenerators {
    ...
    public static void gatherDataEvent(GatherDataEvent event)
    {
        ...
        var builtinEntries = generator.addProvider(event.includeServer(), new DatapackBuiltinEntriesProvider(packOutput, event.getLookupProvider(), new RegistrySetBuilder(), Set.of(PalDelight.MOD_ID)));
